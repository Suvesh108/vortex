...
if os.path.exists(COOKIE_FILE_PATH):
    print(f"[STARTUP] Found cookies.txt at {COOKIE_FILE_PATH}", file=sys.stderr, flush=True)
else:
    print(f"[STARTUP] WARNING: cookies.txt not found at {COOKIE_FILE_PATH}", file=sys.stderr, flush=True)
