      ...
      <div id="guide" className="scroll-mt-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <motion.div
            ...
            className="space-y-4 group p-4 rounded-2xl bg-surface-card/30 border border-gray-800/40 hover:border-action-red/40 transition-colors"
          >
            <div className="flex items-baseline space-x-3">
              <span className="font-hanken font-extrabold text-6xl text-gray-800/40 select-none group-hover:text-action-red/40 transition-colors duration-300">
                01
              </span>
          ...
          <motion.div
            whileHover={{ scale: 1.04, y: -4 }}
            transition={{ type: 'spring', stiffness: 350, damping: 22 }}
            className="space-y-4 group p-4 rounded-2xl bg-surface-card/30 border border-gray-800/40 hover:border-tertiary-blue/40 transition-colors"
          >
            <div className="flex items-baseline space-x-3">
              <span className="font-hanken font-extrabold text-6xl text-gray-800/40 select-none group-hover:text-tertiary-blue/40 transition-colors duration-300">
                02
              </span>
              <h3 className="font-hanken font-bold text-xl text-[#e5e2e1] group-hover:text-white transition-colors">
                Choose
          ...
          <motion.div
            whileHover={{ scale: 1.04, y: -4 }}
            transition={{ type: 'spring', stiffness: 350, damping: 22 }}
            className="space-y-4 group p-4 rounded-2xl bg-surface-card/30 border border-gray-800/40 hover:border-amber-500/40 transition-colors"
          >
            <div className="flex items-baseline space-x-3">
              <span className="font-hanken font-extrabold text-6xl text-gray-800/40 select-none group-hover:text-amber-500/40 transition-colors duration-300">
                03
              </span>
              <h3 className="font-hanken font-bold text-xl text-[#e5e2e1] group-hover:text-white transition-colors">
                Download
      ...
      <div id="features" className="border-t border-gray-800 pt-16 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            transition={{ type: 'spring', stiffness: 350, damping: 22 }}
            className="bg-surface-card border border-gray-800/60 p-6 rounded-2xl space-y-4 hover:border-action-red/40 transition-all duration-200"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.03, y: -4 }}
            transition={{ type: 'spring', stiffness: 350, damping: 22 }}
            className="bg-surface-card border border-gray-800/60 p-6 rounded-2xl space-y-4 hover:border-tertiary-blue/40 transition-all duration-200"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.03, y: -4 }}
            transition={{ type: 'spring', stiffness: 350, damping: 22 }}
            className="bg-surface-card border border-gray-800/60 p-6 rounded-2xl space-y-4 hover:border-purple-500/40 transition-all duration-200"
          >
